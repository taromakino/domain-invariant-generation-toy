...
def make_trainval_data():
    ...
    colors[idxs_y0_e0] = RNG.normal(0.2, 0.125, len(idxs_y0_e0))
    colors[idxs_y1_e0] = RNG.normal(0.6, 0.125, len(idxs_y1_e0))
    colors[idxs_y0_e1] = RNG.normal(0.8, 0.125, len(idxs_y0_e1))
    colors[idxs_y1_e1] = RNG.normal(0.4, 0.125, len(idxs_y1_e1))
