...
def make_model(args, x_size):
    if args.is_erm:
        ...
        if args.ckpt_fpath is None:
            ...
            return VAE.load_from_checkpoint(args.ckpt_fpath, stage=args.stage, q_mult=args.q_mult, lr=args.lr,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage', type=str, choices=['train_vae', 'train_classifier', 'train_q', 'test'], required=True)
