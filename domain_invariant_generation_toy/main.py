...
def make_model(args, task, is_train):
    if task == Task.ERM_X:
        ...
        return vae.VAE(task, X_SIZE[args.dataset], args.z_size, args.rank, args.h_sizes, args.classifier_mult,
            args.prior_mult, args.reg_mult, args.lr, args.weight_decay, args.lr_infer, args.n_infer_steps)
    elif task == Task.Q_Z:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prior_mult', type=float, default=1)
