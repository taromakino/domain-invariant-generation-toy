...
def main(args):
    ...
    vae = VAE(x_train.shape[1], args.z_size, args.h_sizes, n_classes, n_envs, args.prior_likelihood_mult,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prior_likelihood_mult', type=float, default=20)
